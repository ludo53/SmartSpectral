// src/lib.rs
/*
 * Core library for SmartSpectral
 */
...
#[derive(Debug)]
pub struct SmartSpectralProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SmartSpectralProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SmartSpectral processing");
    
    let mut processor = SmartSpectralProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SmartSpectralProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SmartSpectralProcessor::new(false);
